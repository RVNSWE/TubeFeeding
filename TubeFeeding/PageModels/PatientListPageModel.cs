...
namespace TubeFeeding.PageModels
{
    public partial class PatientListPageModel : ObservableObject, INotifyPropertyChanged
    {
        ...
        public AddPatientPageModel NewPatient { get; set; }
        ...
        {
            IEnumerable<Patient> patientsData = await App.Repo.GetAllSchedules();
            Patients = [];
        ...
        {
            IEnumerable<Patient> patientData = await App.Repo.GetAllSchedules();
            Patients.Clear();
