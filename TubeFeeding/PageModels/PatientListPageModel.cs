...
{
    public partial class PatientListPageModel : ObservableObject, INotifyPropertyChanged
    {
        ...
        private string clientNameErrorMessage;
        private string speciesErrorMessage;
        private string bodyWeightErrorMessage;
        private string dietErrorMessage;
        private string kcalPerKgErrorMessage;
        private string netWeightErrorMessage;
        private string percentWaterErrorMessage;
            ...
            )
        {
            ...
            else if (Globals.IsStringEmpty(patient.ClientName))
            {
            ...
            else if (Globals.IsStringEmpty(patient.FoodName))
            {
            ...
            else
            {
                ...
                await App.Repo.AddNewPatient(patient);
